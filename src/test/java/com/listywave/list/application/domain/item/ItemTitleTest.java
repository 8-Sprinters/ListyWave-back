...
class ItemTitleTest {
    ...
    void 최대_제한_길이가_존재한다() {
        ...
        CustomException exception = assertThrows(CustomException.class, () -> new ItemTitle(value));
    ...
    void 주어진_문자열이_값에_포함되는지_여부를_반환한다(String keyword, boolean expect) {
        ItemTitle itemTitle = new ItemTitle("제일 좋아하는 칼국수 맛집 TOP5");

        boolean result = itemTitle.isMatch(keyword);
